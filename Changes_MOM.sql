...
base_data AS (
  SELECT
    ...
    loan_amount,
    CASE
      WHEN (loan_product_id IN ('1','5') OR loan_product_id IS NULL) AND app_name = 'com.whizdm.moneyview.loans' THEN '01.MVL NEW + RETURN'
      WHEN loan_product_id = '6' AND app_name = 'com.whizdm.moneyview.loans' THEN '02.MVL REPEAT'
...
SELECT *
FROM final
WHERE programme NOT LIKE '%Others%'
ORDER BY 1 ASC;
